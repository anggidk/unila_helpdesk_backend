...
type CategoryRepositoryInterface interface {
	...
	FindByID(id string) (*domain.ServiceCategory, error)
	FindByName(name string) (*domain.ServiceCategory, error)
	Upsert(category domain.ServiceCategory) error
	UpdateTemplate(categoryID string, templateID string) error
}
