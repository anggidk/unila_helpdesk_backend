...
type SurveyService struct {
	surveys repository.SurveyRepositoryInterface
...
func NewSurveyService(surveys repository.SurveyRepositoryInterface, tickets repository.TicketRepositoryInterface) *SurveyService {
